   ...
   /* public void initialize(){
    ...
    public void showC(MouseEvent mouseEvent) {
        ...
        if (isFirstPlayerTurn) {
            System.out.println("bazikon aval?");
            if (!isSecondCircle) {
                System.out.println("dayereye aval");
                if (x > 11 && x < 47 && y > 4 && y < 40) {
                    System.out.println("dayere avali por shod");
            ...
            //else dovmi commands for second circles and lines
                ...
                System.out.println("residim b dovomi");
                if (x > 11 && x < 47 && y > 4 && y < 40) {
                    ...
                    if (x1 == sc11.getCenterX() && y1 == sc11.getCenterY()) {
                        if (hl11.isVisible())
                            ...
                            hl11.setFill(Color.web("#98c4c0"));
                            ra11.add(hl11);
                            System.out.println("khat rasm shod");
                            if (ra11.size()==4){
                                r11.setVisible(true);
                                r11.setFill(Color.web("#dcff3e"));
                                allRectangles.add(r11);
